...
export const App = () => {
  ...
  const clampTaskIndex = useCallback((colIdx: number, preferredIndex: number): number => {
  ...
  const navigateTo = useCallback((colIdx: number, taskIdx: number) => {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  const handleJumpInput = useCallback((key: string) => {
    ...
    return (
      <box flexGrow={1}>
        <Board
          ...
          jumpLabels={editorState.mode === "goto" && editorState.gotoSubMode === "jump" ? editorState.jumpLabels : null}

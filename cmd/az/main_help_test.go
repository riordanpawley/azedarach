...
func TestMaybePrintCommandHelpUsesSpecificUsage(t *testing.T) {
	tests := []struct {
		...
		{name: "learn root", args: []string{"learn", "--help"}, want: "Usage: az learn <add|recall|show|review|stale|demote|promote|retire|relate|supersede|suggest|consolidate|suggestion-reject|doctor|gc>"},

...
func TestMaybePrintCommandHelpUsesSpecificUsage(t *testing.T) {
	tests := []struct {
		...
		{name: "legacy issue parent shows canonical help", args: []string{"issue", "document", "--help"}, want: "Usage: az ticket document <add|list|remove> [arguments]"},
		{name: "ticket parent", args: []string{"ticket", "document", "--help"}, want: "Usage: az ticket document <add|list|remove> [arguments]"},
		...
		{name: "orchestrate review leaf", args: []string{"orchestrate", "review", "accept", "--help"}, want: orchestrateReviewUsage},
...
func TestMaybePrintCommandHelpCoversRoutedCommandSurface(t *testing.T) {
	paths := [][]string{
		...
		{"orchestrate", "observe"},
		{"orchestrate", "review"},
		{"orchestrate", "review", "accept"},
		{"orchestrate", "review", "return"},
		{"orchestrate", "prompt"},
		{"orchestrate", "message"},
		{"orchestrate", "capture"},

...
func main() {
	...
	case "issue":
		if len(commandArgs) == 0 {
			fmt.Fprintf(os.Stderr, "Usage: az issue <list|get|get-many|check|doctor|create|split|update|close|finalize|delete|image|dep|bulk-create|bulk-update|fanout> [arguments]\n")
			os.Exit(1)
		}

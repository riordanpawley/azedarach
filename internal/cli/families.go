...
func PrintSpecUsage() {
	...
	fmt.Println("  az spec req list [--json] [--issue <issue-id>] [--status <open|accepted|superseded>] [--query <text>] [--limit <n>] [--id <req-id> ...] [--ids a,b,c]")
	...
	fmt.Println("  az spec req list --query \"daemon lifecycle\" --limit 5")

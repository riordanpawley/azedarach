...
func TestProtocolV52PreservesCombinedOrchestrationViewProjectionDecisionAndLearningContracts(t *testing.T) {
	if CurrentVersion != 52 {
		t.Fatalf("protocol version = %d, want 52", CurrentVersion)
	}

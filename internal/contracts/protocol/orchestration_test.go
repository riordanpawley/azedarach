...
func TestProtocolV50PreservesCombinedOrchestrationViewProjectionDecisionAndLearningContracts(t *testing.T) {
	if CurrentVersion != 50 {
		t.Fatalf("protocol version = %d, want 50", CurrentVersion)
	}

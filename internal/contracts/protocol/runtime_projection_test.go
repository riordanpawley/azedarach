...
func TestRuntimeProjectionZeroValuesAreStable(t *testing.T) {
	...
	got := string(data)
	want := `{"schema_version":2,"protocol_version":8,"snapshot_revision":0,"project_id":"","projections":null}`
	if got != want {

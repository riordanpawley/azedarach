...
func TestCommandSpecRegistryDispatcherTargets(t *testing.T) {
	tests := []struct {
		...
		{command: protocol.CommandLearnActivate, want: CommandDispatchLearn, ok: true},
		{command: protocol.CommandLearnFeedback, want: CommandDispatchLearn, ok: true},
...
func TestCommandSpecRegistryCoversKnownDaemonCommands(t *testing.T) {
	knownCommands := []string{
		...
		commandProjectionDeltaList,
		commandProjectionDeltaWatch,
		commandProjectionSnapshot,
		...
		protocol.CommandDecisionAcknowledge,
		...
		protocol.CommandLearnSuggestionReject,
		CommandGitFetch,
		CommandGitPullBase,
		CommandGitPush,
		CommandGitMerge,
		...
		protocol.CommandValidationAcquire,
		protocol.CommandValidationHeartbeat,
		protocol.CommandValidationNested,

...
func TestProjectOrchestrationEndToEndAcceptanceInventory(t *testing.T) {
	scenarios := []struct {
		...
		{"review-return-active-validation-epoch", TestReviewReturnAcceptsFailedAggregateGateFromCurrentReviewEpochAfterWorkerMovesActive},
		{"review-return-bounded-delivery", TestReviewReturnBoundsBlockedLiveDeliveryAndPublishesFailure},

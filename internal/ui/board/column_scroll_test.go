...
func TestRenderColumn_DoesNotScrollImmediatelyOnNextTask(t *testing.T) {
	...
	out := renderColumn("Open", tasks, 1, true, 0, map[string]bool{}, map[string]RuntimeSignals{}, nil, nil, false, nil, 36, 16, s)
...
func TestRenderColumn_ShowsTopAndBottomScrollIndicatorsConditionally(t *testing.T) {
	...
	topOut := renderColumn("Open", tasks, 0, true, 0, map[string]bool{}, map[string]RuntimeSignals{}, nil, nil, false, nil, 36, 16, s)
	...
	midOut := renderColumn("Open", tasks, 2, true, 2, map[string]bool{}, map[string]RuntimeSignals{}, nil, nil, false, nil, 36, 16, s)

...
func TestRenderCard_WithChildProgress(t *testing.T) {
	...
	result := renderCard(task, nil, false, false, 56, &ChildProgress{Total: 5, Done: 3}, nil, false, "", false, s)
	stripped := stripANSI(result)
...
func TestRenderCard_WithChildProgressAndSession(t *testing.T) {
	...
	result := renderCard(task, nil, false, false, 46, &ChildProgress{Total: 2, Done: 1}, nil, false, "", false, s)
	stripped := stripANSI(result)
...
func TestRenderCard_WithRuntimeSignals(t *testing.T) {
	...
	result := renderCard(task, signals, false, false, 72, nil, nil, false, "", false, s)
	stripped := stripANSI(result)
...
func TestRenderCard_MetadataOnFirstLine(t *testing.T) {
	...
	result := stripANSI(renderCard(task, signals, false, false, 90, &ChildProgress{Total: 7, Done: 1}, nil, false, "", false, s))
...
func TestRenderCard_NarrowWidthUsesSecondHeaderRowBeforeCompaction(t *testing.T) {
	...
	result := stripANSI(renderCard(task, signals, false, false, 40, &ChildProgress{Total: 7, Done: 1}, nil, false, "", false, s))
	lines := strings.Split(result, "\n")
	firstIdx := -1
...
func TestRenderCard_NarrowWidthAddsOneCardRowAndOneHeaderRow(t *testing.T) {
	...
	wide := stripANSI(renderCard(task, signals, false, false, 80, progress, nil, false, "", false, s))
	narrow := stripANSI(renderCard(task, signals, false, false, 22, progress, nil, false, "", false, s))
...
func TestRenderCard_NarrowWidthKeepsVerboseHeaderTokensAcrossTwoRows(t *testing.T) {
	...
	narrow := stripANSI(renderCard(task, signals, false, false, 25, &ChildProgress{Total: 7, Done: 1}, nil, false, "", false, s))
...
func TestRenderCard_HeaderOverflowAddsExtraRows(t *testing.T) {
	...
	narrow := stripANSI(renderCard(task, signals, false, false, 25, progress, nil, false, "", false, s))
	wide := stripANSI(renderCard(task, signals, false, false, 80, progress, nil, false, "", false, s))

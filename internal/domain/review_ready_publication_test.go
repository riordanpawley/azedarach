...
func TestDeriveReviewReadyPublicationsCoalescesEvidenceAroundTransition(t *testing.T) {
	events := []IssueObservationEvent{
		...
		{ID: 2, IssueID: naming.IssueID("az-1"), Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_review"}},
...
func TestDeriveReviewReadyPublicationsPublishesRepeatedResubmissions(t *testing.T) {
	events := []IssueObservationEvent{
		{ID: 1, Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_review"}},
		{ID: 2, Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_progress"}},
		{ID: 3, Type: "worker.integration_ready"},
		{ID: 4, Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_review"}},
		{ID: 5, Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_progress"}},
		{ID: 6, Type: "worker_ready"},
		{ID: 7, Type: IssueEventIssueStatusChanged, Payload: map[string]any{"to_status": "in_review"}},
	}

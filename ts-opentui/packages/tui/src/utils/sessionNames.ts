/**
 * Session naming helpers local to the TUI package.
 *
 * These are pure utilities for tmux-safe session encoding/decoding and
 * project-aware issue lookup. They intentionally exclude broader path helpers.
 */

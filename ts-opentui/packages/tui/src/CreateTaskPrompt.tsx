...
const isTaskType = (value: string): value is (typeof TASK_TYPES)[number] =>
	TASK_TYPES.some((type) => type === value)
const isPriority = (value: number): value is (typeof PRIORITIES)[number] =>
...
export const CreateTaskPrompt = (props: CreateTaskPromptProps) => {
	...
	const initialPriorityIndex =
		props.initialPriority !== undefined && isPriority(props.initialPriority)
			? Math.max(0, PRIORITIES.indexOf(props.initialPriority))
			: 1

...
| [External Sync Overlay Internals](external-sync-backend-internals.md) | Full Linear local-first sync overlay internals with Mermaid diagrams |
...
│                     ▼                                            │
│            ┌─────────────────┐                                   │
│            │  Linear API     │  ◄── Optional sync overlay         │
│            │  (cloud)        │                                   │
│            └─────────────────┘                                   │
└─────────────────────────────────────────────────────────────────┘
```

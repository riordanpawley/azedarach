...
const runWithDiagnostics = <A>(
	program: Effect.Effect<A, never, DiagnosticsService>,
): Promise<A> => Effect.runPromise(program.pipe(Effect.provide(DiagnosticsService.Default)))

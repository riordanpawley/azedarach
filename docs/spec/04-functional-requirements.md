...
- AZ-FR-0821: Session start init gating MUST use a bounded wait and MUST launch the AI command even when init marker completion times out; timeout state MUST be recorded for diagnostics/recovery.

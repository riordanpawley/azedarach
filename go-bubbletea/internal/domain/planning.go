...
type ReviewFeedback struct {
	...
	IsApproved                   bool                `json:"isApproved"`                   // Ready for linear generation?
}
...
const (
	...
	PlanningCreatingIssues PlanningStatus = "creating_issues"
...
type PlanningState struct {
	...
	CreatedIssues      []Task           // Linear created from the plan
...
type PlanningError struct {
	Phase   string // Phase: "generation", "review", "refinement", "issues_creation"
